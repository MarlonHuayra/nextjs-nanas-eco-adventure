...
import heroImg from "/public/img/nanaBodyB.png";
import Link from "next/link";

const Hero = () => {
  return (
    <>
      <Container className="flex flex-wrap  bg-red">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-white lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Nana's Eco Adventure
            </h1>
            <p className="py-5 text-xl leading-normal text-lightblue lg:text-xl xl:text-2xl dark:text-gray-300">
              Aprendizaje Interactivo sobre el Cuidado del Medio Ambiente.
            </p>

            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <Link
                href="/videos/nanaDemo.mp4"
                className="text-xl font-semibold text-white py-4 px-6 lg:px-12 navbutton"
              >
                <h3>Wacht Demo</h3> <Image
                    src="/img/play.png"
                    alt="N"
                    width="24"
                    height="324"
              ...
              <a
                href="https://github.com/MarlonHuayra/nanas-adventure"
                target="_blank"
                rel="noopener"
