        ...
        <div className="mx-auto max-w-7xl mt-48 mb-16 px-6 relative">
            ...
            <div className="grid lg:grid-cols-2 gap-x-5">
                ...
                <div>
                    ...
                    <p className="lg:text-lg font-normal text-lightblue mb-16 text-center sm:text-start"> marlon Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
